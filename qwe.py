...
# IP Webcam URL (replace with the actual URL of your IP webcam stream)
# Example: http://192.168.1.100:8080/video
ip_webcam_url = 'https://192.168.54.242:8080/video'
...
while True:
    ...
    # Display the dehazed frame in a separate window
